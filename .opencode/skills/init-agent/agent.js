...
// ---------------------------------------------------------------------------
// Behavioral guidelines: append Karpathy guidelines to project AGENTS.md
// ---------------------------------------------------------------------------
function appendBehavioralGuidelinesToAgentsMd(roleName) {
  const agentsMdPath = path.resolve(SKILL_DIR, '..', '..', '..', 'AGENTS.md');
  if (!fs.existsSync(agentsMdPath)) return;

  // Check if guidelines section already exists — avoid duplicates
...
async function createRoleInteractive(name, options = {}) {
  ...
  // Append Karpathy behavioral guidelines to AGENTS.md
